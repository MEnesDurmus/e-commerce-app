...
const TextStyle textStyle15GreyMedium = const TextStyle(
    fontSize: 15, color: textColor2, fontWeight: FontWeight.w400);

const TextStyle textStyle15GreyRegular = const TextStyle(
    fontSize: 15, color: textColor2, fontWeight: FontWeight.normal);
